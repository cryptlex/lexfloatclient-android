...
# cp $ANDROID_NDK_ROOT/platform-tools/lib64/libc++.so lexfloatclient/src/main/jniLibs/arm64-v8a
cp $ANDROID_NDK_ROOT/platform-tools/lib64/libc++.so lexfloatclient/src/main/jniLibs/armeabi-v7a
